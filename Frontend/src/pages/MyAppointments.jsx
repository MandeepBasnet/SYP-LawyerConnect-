...
const MyAppointments = () => {
  ...
  return (
    <div>
      ...
      <div>
        {lawyers.slice(0,3).map((item, index) => (
          <div className='grid grid-cols-[1fr_3fr] gap-4 sm:flex sm:gap-6 py-2 border-b' key={index}>
            ...
            <div className='flex-1 text-sm text-zinc-600'>
              ...
              <p className='text-xs mt-1'><span className='text-sm text-neutral-700 font-medium'>Date and Time:</span>25, May, 2024 | 10:00 AM</p>
            </div>
            <div></div>
